...
def main():
    ...
    scale_paths = ["data_esd_normalized", "bkg_esd_normalized"]
    ...
    if not buf_path.exists():
        buf_path.mkdir()
    data_norm_path = Path.cwd() / "data_esd_normalized"
    bkg_norm_path = Path.cwd() / "bkg_esd_normalized"
